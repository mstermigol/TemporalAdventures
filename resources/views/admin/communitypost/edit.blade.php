...
<div class="container my-5">
    <a href="{{ route('admin.communitypost.index') }}" class="btn btn-primary mb-3"><i
    ...
    <form action="{{ route('admin.communitypost.update', $viewData['communityPost']->getId()) }}" method="POST"
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" name="title" value="{{ $viewData['communityPost']->getTitle() }}"
                required>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control custom-height-300" id="description" name="description" rows="3"
                required>{{ $viewData['communityPost']->getDescription() }}</textarea>
        </div>
