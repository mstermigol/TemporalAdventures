        ...
        <form method="POST" action="{{ route('admin.user.update', ['id'=> $viewData['user']->getId()]) }}">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="mb-3 row">
                        ...
                        <div class="col-lg-10 col-md-6 col-sm-12">
                            <input name="balance" value="{{ $viewData['user']->getBalance() }}" type="number"
                                class="form-control">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="mb-3 row">
                        <label
                            class="col-lg-2 col-md-6 col-sm-12 col-form-label">@lang('admin.user.phone_number'):</label>
                        <div class="col-lg-10 col-md-6 col-sm-12">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-lg-10 col-md-6 col-sm-12">
                            <select name="is_staff" id="is_staff" class="form-control">
                                <option value="0" @if($viewData['user']->getIsStaff() == 0) selected
                                    @endif>@lang('admin.user.regular')</option>
                                <option value="1" @if($viewData['user']->getIsStaff() == 1) selected
                                    @endif>@lang('admin.user.admin')</option>
                            </select>
                        </div>
                    </div>
                </div>
