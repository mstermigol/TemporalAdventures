            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end container-fluid">
                        <a href="{{ route('admin.review.show', ['id' => $review->getId()]) }}" class="btn btn-dark me-1"><i class="fas fa-eye"></i></a>
                        @if(Auth::user()->getId() === $review->getUserId())
                        <a href="{{ route('admin.review.edit', ['id' => $review->getId()]) }}" class="btn btn-primary me-1"><i class="fas fa-pencil-alt"></i></a>
                        @endif
