    ...
    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto">
                            <button class="btn bg-primary text-white"
                                type="submit">@lang('app.content_travels.add_to_cart')</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div>
            <div class="card my-4">
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('travel.review.save', ['reviewOfId' => $viewData['travel']->getId()]) }}">
                        @csrf
            ...
            <div class="card mt-3">
                <div class="card-body d-flex justify-content-between align-items-start">
                    ...
                    <div class="d-flex justify-content-between">
                        <form method="POST" action="{{ route('travel.review.delete', $review->getId()) }}"
                            class="d-inline">
                            @csrf
                            @method('DELETE')
